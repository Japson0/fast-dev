...
public class UserInjectInterceptor  implements CustomInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        UserContext.setUserInfo(new UserWrapper(userInfo.getUserId(),userInfo.getNickName(),userInfo.getUsername(),userInfo.getTenantId(), userInfo.getSchoolId(),userInfo.getRoles()));
