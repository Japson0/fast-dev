//package net.github.fastdev.mybatis.sqlparser;
//
...
// * @version1.0
// */
//public class MultiTenantLineInnerInterceptor extends BaseMultiTableInnerInterceptor {
//
//
//    private MultiTenantLineHandler tenantLineHandler;
//
//    public MultiTenantLineInnerInterceptor(MultiTenantLineHandler tenantLineHandler) {
...
//        Expression tenantId = tenantLineHandler.getWriteTenantId();
...
//            }));
//        }
//        update.setWhere(this.andExpression(table, update.getWhere(), (String) obj,true));
//    }
//
//    /**
//     * delete 语句处理
...
//            return;
//        }
//        delete.setWhere(this.andExpression(delete.getTable(), delete.getWhere(), (String) obj,true));
//    }
//
//    /**
...
//            return null;
//        }
//        Expression tenantId = tenantLineHandler.getReadTenantId(table.getName());
//        if(tenantId instanceof List){
//            return new InExpression(getAliasColumn(table),tenantId);
//        }
...
//     * @see BaseMultiTableInnerInterceptor#buildTableExpression(Table, Expression, String)
//     */
//    public Expression buildWriteTableExpression(final Table table, final Expression where, final String whereSegment) {
//        if (tenantLineHandler.ignoreTable(table.getName())) {
//            return null;
//        }
//        Expression writeTenantId = tenantLineHandler.getWriteTenantId();
//        return new EqualsTo(getAliasColumn(table), writeTenantId);
//    }
//
//    protected Expression andExpression(Table table, Expression where, final String whereSegment, boolean write) {
//        //获得where条件表达式
//        Expression expression;
//        if (write) {
//            expression = buildWriteTableExpression(table, where, whereSegment);
//        } else {
//            expression = buildTableExpression(table, where, whereSegment);
//        }
//        if (where != null) {
