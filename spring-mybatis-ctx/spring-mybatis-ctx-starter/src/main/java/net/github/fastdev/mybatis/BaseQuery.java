...
import net.github.fastdev.mybatis.query.EscapeQueryWrapper;
import net.github.fastdev.mybatis.query.OracleQueryWrapper;
import net.github.fastdev.mybatis.query.QueryInspection;
...
public class BaseQuery<T> {
    ...
    protected static QueryWrapper initQuery(QueryWrapper queryWrapper, Operation sqlCondition, String column, final Object value) {
        switch (sqlCondition) {
            case EQ: {
