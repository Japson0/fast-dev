 ...
 *
 */
package net.github.elastic.service.impl;
...
import net.github.elastic.annotations.ElasticIndex;
import net.github.elastic.enums.OrderType;
import net.github.elastic.enums.TotalHitRelation;
import net.github.elastic.exception.ElasticException;
import net.github.elastic.indexbuilder.ElasticIndexBuild;
import net.github.elastic.indexbuilder.ElasticQueryIndicesBuild;
import net.github.elastic.model.EPageRequest;
import net.github.elastic.model.ESort;
import net.github.elastic.model.EsBaseEntity;
import net.github.elastic.pojo.EObjectQueryWrapper;
import net.github.elastic.pojo.EQueryWrapper;
import net.github.elastic.result.CommonAnalysis;
import net.github.elastic.result.HighLightAnalysis;
import net.github.elastic.result.ResultAnalysis;
import net.github.elastic.result.ResultType;
import net.github.elastic.service.ElasticSearch;
