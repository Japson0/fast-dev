...
package net.github.elastic.pojo;

import co.elastic.clients.elasticsearch._types.query_dsl.QueryVariant;
import co.elastic.clients.elasticsearch.core.search.Highlight;
import co.elastic.clients.elasticsearch.core.search.HighlightField;
import co.elastic.clients.util.ObjectBuilder;
import net.github.elastic.annotations.*;
import net.github.elastic.enums.ElasticOperator;
import net.github.elastic.func.EOperateFunc;
import net.github.elastic.func.MatchConfigConsumer;
import net.github.elastic.func.MatchPhraseConfigConsumer;
import net.github.elastic.func.MatchPhrasePrefixConfigConsumer;
